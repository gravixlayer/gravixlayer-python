...
r = runtime.git.fetch(clone_path, remote="origin")
...
r = runtime.git.pull(clone_path, remote="origin", branch=branch)
...
if user and pwd:
    r = runtime.git.push(clone_path, remote="origin", username=user, password=pwd)
