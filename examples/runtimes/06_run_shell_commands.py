#!/usr/bin/env python3
"""
Run Shell Commands in a Runtime

Execute shell commands inside a running runtime. Useful for package
...
# ---------------------------------------------------------------------------
result = client.runtime.run_command(sid, command="uname", args=["-a"])
print(f"\n--- uname -a ---")
