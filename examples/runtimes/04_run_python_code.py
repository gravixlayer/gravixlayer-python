#!/usr/bin/env python3
"""
Execute Python Code in a Runtime

Shows how to run Python code snippets inside a runtime using the
...
result = client.runtime.run_code(sid, code=code, language="python")
print(f"\n--- System info ---")
print(f"Output     : {result.logs}")
