...
class AsyncVectors:
    ...
    async def batch_upsert(self, vectors: List[Dict[str, Any]]) -> BatchUpsertResponse:
        """
    ...
    async def batch_upsert_text(self, vectors: List[Dict[str, Any]]) -> BatchUpsertResponse:
        """
    ...
    async def list(self, vector_ids: Optional[List[str]] = None) -> VectorDictResponse:
        """
