...
class CloudConfig:
    ...
    def to_dict(self) -> Dict[str, str]:
        return {"cloud_provider": self.cloud_provider, "region": self.region, "index_type": self.index_type}
...
class DynamicMemoryConfig:
    ...
    def switch_cloud_config(
        self, provider: Optional[str] = None, region: Optional[str] = None, index_type: Optional[str] = None
    ) -> bool:
