...
```python
sb = client.runtime.get("runtime-id")
```

#### Kill

```python
client.runtime.kill("runtime-id")
```
...
```python
# Run Code
code_result = runtime.run_code("print('Hello World')")
print(code_result.stdout)

# Run Command
cmd_result = runtime.run_command("ls -la")
print(cmd_result.stdout)

# Filesystem: Write
runtime.filesystem.write("test.txt", "Hello content")

# Filesystem: Read
content = runtime.filesystem.read("test.txt")

# Filesystem: List
files = runtime.filesystem.list("/")

# Filesystem: Create Directory
runtime.filesystem.create_directory("new-dir")

# Filesystem: Delete
runtime.filesystem.delete("test.txt")
